      ...
      {loading ? (
        ...
        <div className="rounded-lg bg-white shadow-lg p-5">
                ...
                currentData.map((item) => (
                  ...
                  >
                    ...
                    <div className="mt-2 flex justify-center gap-2">
                      ...
                      <button
                        onClick={() => openModal("edit", item)}
                        className="bg-sky-500 text-white hover:bg-sky-600 py-2 px-4 rounded-lg transition duration-200"
                      >
                        Edit
                      </button>
                      <button
          ...
          <div className="mt-4 flex justify-center items-center space-x-2">
            ...
            <span className="px-4 py-2 border rounded-lg bg-sky-500 text-white">
