...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-400 via-sky-500 to-sky-600 px-6 py-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="flex justify-between mt-6">
            <button
              ...
              className="bg-sky-400 hover:bg-sky-500 text-white py-2 px-4 rounded-lg"
            >
              Prev
            </button>
